        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-neutral-400">
              A multi-faceted holding company committed to excellence across multiple verticals. We combine strategic vision with operational expertise to build and grow businesses.
            </p>
            {/* Social Media */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/corporate#who-we-are" className="text-sm text-neutral-400 hover:text-primary-400 transition-colors">Who We Are</Link>
              </li>
              <li>
