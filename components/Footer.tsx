...
const tourLinks = [
  { name: "Bagan Tours", href: "/tours/bagan-temples-exploration" },
  { name: "Inle Lake", href: "/tours/inle-lake-adventure" },
  { name: "Yangon City", href: "/tours/yangon-city-discovery" },
  { name: "Beach Escapes", href: "/tours/ngapali-beach-escape" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-6 text-sm leading-relaxed text-neutral-400">
              ...
              beyond. We specialize in crafting unforgettable journeys that blend
              adventure, culture, and authentic experiences.
            </p>
            {/* Social Media */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-500">
              © {currentYear} NAY YAR THIT FUTURE COMPANY LIMITED. All rights
              reserved.
            </p>
