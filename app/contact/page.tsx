...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with NAY YAR THIT Travel & Tours. We're here to help you plan your perfect trip to Myanmar and beyond.",
  openGraph: {
    title: "Contact Us | NAY YAR THIT Travel & Tours",
    description:
      "Get in touch with us for travel inquiries, bookings, and custom tour requests.",
  },
};
...
const contactInfo = [
  {
    ...
    lines: [
      "No. 71/84, San Sai 10 Street,",
      "San Sai A Quarter, Tachileik Township,",
      "Shan State, 06271, Myanmar",
    ],
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: "Email Us",
    lines: ["nayyarthitfuture@gmail.com"],
  ...
  },
  {
    ...
    lines: ["Monday - Friday: 9:00 AM - 6:00 PM", "Saturday: 9:00 AM - 1:00 PM", "Sunday: Closed"],
  },
];
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                ...
                <p className="text-neutral-600 mb-8">
                  Whether you have a question about our tours, need help planning a
                  custom trip, or just want to say hello, we&apos;re here to help.
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-neutral-200">
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full bg-neutral-100 text-neutral-600 flex items-center justify-center hover:bg-primary-100 hover:text-primary-600 transition-colors"
                    aria-label="Facebook"
                  >
                    <svg
                      className="w-5 h-5"
