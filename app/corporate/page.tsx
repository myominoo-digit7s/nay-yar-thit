      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${reverse ? 'lg:flex-row-reverse' : ''}`}>
          ...
          <div className={`space-y-6 ${reverse ? 'lg:order-2' : ''}`}>
            ...
            {/* <div className="pt-2">
              <Link href="#" className="inline-flex items-center gap-1 text-slate-900 font-medium hover:text-slate-600 transition-colors">
    ...
    <section id="contact" className="py-24 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
        <h2 className="text-3xl font-bold sm:text-4xl mb-4">
          Partner with Nay Yar Thit
        </h2>
        <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-8">
          Whether you are looking for premium travel experiences, cutting-edge software solutions, or engaging media content, we are here to help you grow.
        </p>
        <Link href="#" className="bg-white hover:bg-slate-50 text-slate-900 px-8 py-3 rounded-lg font-medium transition-colors shadow-lg flex items-center justify-center gap-2 inline-flex">
